...
#SBATCH --job-name=larmip6
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=128000
#SBATCH --time=8:00:00
#SBATCH --output=out_larmip6.txt
#SBATCH --error=error_larmip6.txt
#SBATCH --export=ALL
...
mv *tlim2.0win0.25*globalsl* ../output_global
mv *tlim2.0win0.25*localsl* ../output_local

rm *tlim2.0win0.25*.pkl
