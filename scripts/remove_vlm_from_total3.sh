...
#SBATCH --job-name=3remvlm
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=192000
#SBATCH --time=144:00:00
#SBATCH --output=out_remove_vlm_from_total3.txt
#SBATCH --error=error_remove_vlm_from_total3.txt
#SBATCH --export=ALL
...
# Values
BINDIR="${MAINDIR}/regional/full_sample_workflows/wf_2f"
BOUTDIR="${MAINDIR}/regional_novlm/full_sample_workflows/wf_2f"
...
# Rates
BINDIR="${MAINDIR}/regional/full_sample_workflows_rates/wf_2f"
BOUTDIR="${MAINDIR}/regional_novlm/full_sample_workflows_rates/wf_2f"
