...
WFDIR="/projects/kopp/ar6/regional/full_sample_workflows/wf_1f"
...
cp ${PROJDIR}/icesheets-ar5-icesheets-ssp119_AIS_localsl.nc ./ssp119/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-ssp126_AIS_localsl.nc ./ssp126/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-ssp245_AIS_localsl.nc ./ssp245/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-ssp370_AIS_localsl.nc ./ssp370/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-ssp585_AIS_localsl.nc ./ssp585/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-tlim1.5win0.25_AIS_localsl.nc ./tlim1.5win0.25/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-tlim2.0win0.25_AIS_localsl.nc ./tlim2.0win0.25/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-tlim3.0win0.25_AIS_localsl.nc ./tlim3.0win0.25/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-tlim4.0win0.25_AIS_localsl.nc ./tlim4.0win0.25/
...
cp ${PROJDIR}/icesheets-ar5-icesheets-tlim5.0win0.25_AIS_localsl.nc ./tlim5.0win0.25/
