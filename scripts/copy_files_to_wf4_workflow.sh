...
WFDIR="/projects/kopp/ar6/regional/full_sample_workflows/wf_4"
...
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp126_AIS_localsl.nc ./ssp126/
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp126_GIS_localsl.nc ./ssp126/
...
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp245_AIS_localsl.nc ./ssp245/
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp245_GIS_localsl.nc ./ssp245/
...
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp585_AIS_localsl.nc ./ssp585/
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp585_GIS_localsl.nc ./ssp585/
...
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-tlim2.0win0.25_AIS_localsl.nc ./tlim2.0win0.25/
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-tlim2.0win0.25_GIS_localsl.nc ./tlim2.0win0.25/
...
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-tlim5.0win0.25_AIS_localsl.nc ./tlim5.0win0.25/
cp ${PROJDIR}/icesheets-ipccar6-bambericesheet-tlim5.0win0.25_GIS_localsl.nc ./tlim5.0win0.25/
