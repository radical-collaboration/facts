...
#SBATCH --job-name=2remvlm
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=128000
#SBATCH --time=144:00:00
#SBATCH --output=out_remove_vlm_from_total2.txt
#SBATCH --error=error_remove_vlm_from_total2.txt
#SBATCH --export=ALL
...
# Values
BINDIR="${MAINDIR}/regional/full_sample_workflows/wf_2e"
BOUTDIR="${MAINDIR}/regional_novlm/full_sample_workflows/wf_2e"
...
# Rates
BINDIR="${MAINDIR}/regional/full_sample_workflows_rates/wf_2e"
BOUTDIR="${MAINDIR}/regional_novlm/full_sample_workflows_rates/wf_2e"
