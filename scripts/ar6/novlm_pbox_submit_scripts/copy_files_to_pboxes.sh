...
bash copy_files_to_pb1e_pbox_novlm.sh
bash copy_files_to_pb1e_pbox_rates_novlm.sh
...
bash copy_files_to_pb2e_pbox_novlm.sh
bash copy_files_to_pb2e_pbox_rates_novlm.sh
...
bash copy_files_to_pb1f_pbox_novlm.sh
bash copy_files_to_pb1f_pbox_rates_novlm.sh
...
bash copy_files_to_pb2f_pbox_novlm.sh
bash copy_files_to_pb2f_pbox_rates_novlm.sh
