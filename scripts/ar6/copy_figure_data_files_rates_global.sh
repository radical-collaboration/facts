...
#SBATCH --job-name=copy_figs_rates_glob
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=32000
#SBATCH --time=24:00:00
#SBATCH --output=out_copy_figure_data_files_rates_global.txt
#SBATCH --error=error_copy_figure_data_files_rates_global.txt
#SBATCH --export=ALL
...
FIGDIR="/projects/kopp/ar6/global/figure_data_rates"
WFDIR="/projects/kopp/ar6/global/dist_workflows_rates"
SCRIPTDIR="/projects/kopp/ar6/scripts"
PBDIR="/projects/kopp/ar6/global/pboxes_rates"
