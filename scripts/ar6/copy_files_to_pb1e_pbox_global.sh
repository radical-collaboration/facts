...
PBDIR="/projects/kopp/ar6/global/pboxes/pb_1e"
...
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-ssp119_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp119_TOT_globalsl.nc --outfile ./ssp119/icesheets-pb1e-icesheets-ssp119_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-ssp126_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp126_TOT_globalsl.nc --outfile ./ssp126/icesheets-pb1e-icesheets-ssp126_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-ssp245_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp245_TOT_globalsl.nc --outfile ./ssp245/icesheets-pb1e-icesheets-ssp245_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-ssp370_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp370_TOT_globalsl.nc --outfile ./ssp370/icesheets-pb1e-icesheets-ssp370_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-ssp585_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp585_TOT_globalsl.nc --outfile ./ssp585/icesheets-pb1e-icesheets-ssp585_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-tlim1.5win0.25_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim1.5win0.25_TOT_globalsl.nc --outfile ./tlim1.5win0.25/icesheets-pb1e-icesheets-tlim1.5win0.25_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-tlim2.0win0.25_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim2.0win0.25_TOT_globalsl.nc --outfile ./tlim2.0win0.25/icesheets-pb1e-icesheets-tlim2.0win0.25_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-tlim3.0win0.25_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim3.0win0.25_TOT_globalsl.nc --outfile ./tlim3.0win0.25/icesheets-pb1e-icesheets-tlim3.0win0.25_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-tlim4.0win0.25_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim4.0win0.25_TOT_globalsl.nc --outfile ./tlim4.0win0.25/icesheets-pb1e-icesheets-tlim4.0win0.25_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ipccar6-ismipemuicesheet-tlim5.0win0.25_AIS_globalsl.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim5.0win0.25_TOT_globalsl.nc --outfile ./tlim5.0win0.25/icesheets-pb1e-icesheets-tlim5.0win0.25_AIS_globalsl.nc --pyear_start 2020 --pyear_end 2100 --pyear_step 10
