...
WFDIR="/projects/kopp/ar6/global/full_sample_workflows/wf_2e"
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp119_TOT_globalsl.nc ./ssp119/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp126_TOT_globalsl.nc ./ssp126/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp245_TOT_globalsl.nc ./ssp245/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp370_TOT_globalsl.nc ./ssp370/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp585_TOT_globalsl.nc ./ssp585/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim1.5win0.25_TOT_globalsl.nc ./tlim1.5win0.25/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim2.0win0.25_TOT_globalsl.nc ./tlim2.0win0.25/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim3.0win0.25_TOT_globalsl.nc ./tlim3.0win0.25/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim4.0win0.25_TOT_globalsl.nc ./tlim4.0win0.25/
...
cp ${PROJDIR}/icesheets-ipccar6-larmipicesheet-tlim5.0win0.25_TOT_globalsl.nc ./tlim5.0win0.25/
