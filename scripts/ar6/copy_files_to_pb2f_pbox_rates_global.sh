...
PBDIR="/projects/kopp/ar6/global/pboxes_rates/pb_2f"
...
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-FittedISMIP-icesheets-ssp126_GIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp126_GIS_globalsl_rates.nc --outfile ./ssp126/icesheets-pb2f-icesheets-ssp126_GIS_globalsl_rates.nc --pyear_start 2020 --pyear_end 2300 --pyear_step 10
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ar5-icesheets-ssp126_AIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp126_TOT_globalsl_rates.nc ${PROJDIR}/icesheets-dp20-icesheet-ssp126_AIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp126_AIS_globalsl_rates.nc --outfile ./ssp126/icesheets-pb2f-icesheets-ssp126_AIS_globalsl_rates.nc --pyear_start 2020 --pyear_end 2300 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-FittedISMIP-icesheets-ssp245_GIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp245_GIS_globalsl_rates.nc --outfile ./ssp245/icesheets-pb2f-icesheets-ssp245_GIS_globalsl_rates.nc --pyear_start 2020 --pyear_end 2300 --pyear_step 10
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ar5-icesheets-ssp245_AIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp245_TOT_globalsl_rates.nc ${PROJDIR}/icesheets-dp20-icesheet-ssp245_AIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp245_AIS_globalsl_rates.nc --outfile ./ssp245/icesheets-pb2f-icesheets-ssp245_AIS_globalsl_rates.nc --pyear_start 2020 --pyear_end 2300 --pyear_step 10
...
# Generate the pbox component and total files
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-FittedISMIP-icesheets-ssp585_GIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp585_GIS_globalsl_rates.nc --outfile ./ssp585/icesheets-pb2f-icesheets-ssp585_GIS_globalsl_rates.nc --pyear_start 2020 --pyear_end 2300 --pyear_step 10
srun python ${SCRIPTDIR}/generate_pbox_components_dev.py --infiles ${PROJDIR}/icesheets-ar5-icesheets-ssp585_AIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-larmipicesheet-ssp585_TOT_globalsl_rates.nc ${PROJDIR}/icesheets-dp20-icesheet-ssp585_AIS_globalsl_rates.nc ${PROJDIR}/icesheets-ipccar6-bambericesheet-ssp585_AIS_globalsl_rates.nc --outfile ./ssp585/icesheets-pb2f-icesheets-ssp585_AIS_globalsl_rates.nc --pyear_start 2020 --pyear_end 2300 --pyear_step 10
