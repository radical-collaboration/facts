...
#SBATCH --job-name=1remvlm
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=192000
#SBATCH --time=144:00:00
#SBATCH --output=out_remove_vlm_from_total1.txt
#SBATCH --error=error_remove_vlm_from_total1.txt
#SBATCH --export=ALL
...
# Values
BINDIR="${MAINDIR}/regional/full_sample_workflows/wf_1f"
BOUTDIR="${MAINDIR}/regional_novlm/full_sample_workflows/wf_1f"
...
# Rates
BINDIR="${MAINDIR}/regional/full_sample_workflows_rates/wf_1f"
BOUTDIR="${MAINDIR}/regional_novlm/full_sample_workflows_rates/wf_1f"
