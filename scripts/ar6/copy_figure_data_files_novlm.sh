...
#SBATCH --job-name=copy_figs
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=128000
#SBATCH --time=144:00:00
#SBATCH --output=out_copy_figure_data_files.txt
#SBATCH --error=error_copy_figure_data_files.txt
#SBATCH --export=ALL
...
FIGDIR="/projects/kopp/ar6/regional_novlm/figure_data"
WFDIR="/projects/kopp/ar6/regional_novlm/dist_workflows"
SCRIPTDIR="/projects/kopp/ar6/scripts"
PBDIR="/projects/kopp/ar6/regional_novlm/pboxes"
