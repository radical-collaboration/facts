...
def ar5_fit_thermalexpansion(pipeline_id):
	'''
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the thermalexpansion fitting stage for the AR5 SLR projection workflow",\
	...
	ar5_fit_thermalexpansion(args.pipeline_id)
