...
''' dp20_project_icesheet.py

Runs the dp20 icesheet projection stage.
...
def dp20_project_icesheet(nsamps, pyear_start, pyear_end, pyear_step, pipeline_id, replace, rngseed):
...
def WriteNetCDF(icesamps, icetype, data_years, scenario, pipeline_id):
	...
	# Assign attributes
	rootgrp.description = "Global SLR contribution from {} according to DP20 workflow".format(icetype)
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the DP 20 projection stage.",\
	...
	dp20_project_icesheet(args.nsamps, args.pyear_start, args.pyear_end, args.pyear_step, args.pipeline_id, args.replace, args.seed)
