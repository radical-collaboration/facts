...
Preprocess data for use in the dp20 icesheet module.
...
def dp20_preprocess_icesheet(scenario, baseyear, pipeline_id):

	# Define the input file names based on scenario
	eais_filename = "dp20_eais_{}.nc".format(scenario)
	wais_filename = "dp20_wais_{}.nc".format(scenario)
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the DP20 icesheet pre-processing stage.",\
	...
	dp20_preprocess_icesheet(args.scenario, args.baseyear, args.pipeline_id)
