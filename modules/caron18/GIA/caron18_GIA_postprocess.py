...
def caron18_postprocess_GIA(nsamps, rng_seed, baseyear, pyear_start, pyear_end, pyear_step, locationfilename, chunksize, pipeline_id):
	...
	#quant = np.linspace(0.01, 0.99, 99)
	vlm_outq = vlm_out.quantile([0.01,0.05,0.17,0.50,0.83,0.95,0.99], dim='samples')
	vlm_outq.to_netcdf("{0}_quantiles.nc".format(pipeline_id), encoding={"sea_level_change": {"dtype": "f4", "zlib": True, "complevel":4, "_FillValue": nc_missing_value}})
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the post-processing stage for the Caron 18 GIA workflow",\
	...
	caron18_postprocess_GIA(args.nsamps, args.seed, args.baseyear, args.pyear_start, args.pyear_end, args.pyear_step, args.locationfile, args.chunksize, args.pipeline_id)
