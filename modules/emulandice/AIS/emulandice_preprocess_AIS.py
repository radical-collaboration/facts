...
def emulandice_preprocess_AIS(infile, baseyear, pipeline_id):
...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="Run the preprocess stage for the emulandice AIS module.",\
