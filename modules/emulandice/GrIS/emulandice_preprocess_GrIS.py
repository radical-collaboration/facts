...
def emulandice_preprocess_GrIS(infile, baseyear, pipeline_id):
...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="Run the preprocess stage for the emulandice GrIS module.",\
	...
	emulandice_preprocess_GrIS(args.input_data_file, args.baseyear, args.pipeline_id)
