...
def kopp14_postprocess_icesheets(samptype, locationfilename, chunksize, pipeline_id):
	...
	ncvar_attributes = {"description": "Local SLR contributions from icesheets according to Kopp 2014 workflow",
...
if __name__ == '__main__':
	...
	kopp14_postprocess_icesheets(args.samp_type, args.locationfile, args.chunksize, args.pipeline_id)
