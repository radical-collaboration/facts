...
''' FittedISMIP_project_icesheets.py
...
def FittedISMIP_project_icesheets(nsamps, pyear_start, pyear_end, pyear_step, cyear_start, cyear_end, baseyear, pipeline_id, rngseed):
	...
	for icesource in icesources:
		...
		WriteNetCDF(samps, icesource, targyears[targyear_idx], scenario, pipeline_id)
	...
	output = {'samps_dict': samps_dict, 'scenario': scenario, 'targyears': targyears[targyear_idx]}
...
def WriteNetCDF(icesamps, icetype, data_years, scenario, pipeline_id):
	...
	# Assign attributes
	rootgrp.description = "Global SLR contribution from {} according to FittedISMIP icesheets workflow".format(icetype)
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the FittedISMIP icesheets projection stage.",\
	...
	FittedISMIP_project_icesheets(args.nsamps, args.pyear_start, args.pyear_end, args.pyear_step, args.crateyear_start, args.crateyear_end, args.baseyear, args.pipeline_id, args.seed)
