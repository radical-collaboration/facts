...
''' FittedISMIP_preprocess_icesheets.py

Preprocess data for use in the ismip6gis icesheet module.
...
def FittedISMIP_preprocess_icesheets(scenario, tlm_flag, pipeline_id):
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description="Run the FittedISMIP icesheets pre-processing stage.",\
	...
	parser.add_argument('--tlm_data', help="Use two-layer model temperature trajectories [default = 0, do not use]", choices=[0,1], type=int)
	...
	FittedISMIP_preprocess_icesheets(args.scenario, args.tlm_data, args.pipeline_id)
