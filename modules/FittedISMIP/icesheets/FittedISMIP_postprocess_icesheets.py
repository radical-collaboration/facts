...
def FittedISMIP_postprocess_icesheet(locationfilename, pipeline_id):
	...
	waissamps = samps_dict["WAIS"].T + samps_dict["PEN"].T
	eaissamps = samps_dict["EAIS"].T
	gissamps = samps_dict["GIS"].T
	...
	# Write to netcdf
	writeNetCDF(gissl, pipeline_id, "GIS", targyears, site_lats, site_lons, site_ids, scenario)
...
def writeNetCDF(data, pipeline_id, icesheet_name, targyears, site_lats, site_lons, site_ids, scenario):
	...
	# Assign attributes
	rootgrp.description = "Local SLR contributions from {} icesheet according to FittedISMIP workflow".format(icesheet_name)
	rootgrp.history = "Created " + time.ctime(time.time())
	rootgrp.source = "SLR Framework: FittedISMIP workflow"
...
if __name__ == '__main__':
	...
	FittedISMIP_postprocess_icesheet(args.locationfile, args.pipeline_id)
