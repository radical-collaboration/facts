...
def ipccar6_project_larmipicesheet(nsamps, pipeline_id, cyear_start, cyear_end, replace, rngseed):
	...
	WriteNetCDF(pipeline_id, antsmb, years, nsamps, "SMB", scenario)
	WriteNetCDF(pipeline_id, antsmb + ais_samps, years, nsamps, "TOT", scenario)
