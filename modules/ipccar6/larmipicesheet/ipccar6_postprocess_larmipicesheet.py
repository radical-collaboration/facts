...
def writeNetCDF(data, pipeline_id, icesheet_name, targyears, site_lats, site_lons, site_ids, scenario):
	...
	# Assign attributes
	rootgrp.description = "Local SLR contributions from {} icesheet according to ipccar6 workflow".format(icesheet_name)
	rootgrp.history = "Created " + time.ctime(time.time())
	rootgrp.source = "SLR Framework: ipccar6 workflow"
...
if __name__ == '__main__':
	...
	ipccar6_postprocess_larmipicesheet(args.locationfile, args.pipeline_id)
