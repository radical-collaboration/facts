...
def SubsetSLEProjections(sample_dict):
	...
	for this_scenario in sample_dict.keys():
		...
		this_sle_dict = filter_data(this_sle_dict, "FAIR", sample=sample_dict[this_scenario], ice_source=["AIS", "GrIS"])
