...
#SBATCH --job-name=copy_figs_glob
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=32000
#SBATCH --time=24:00:00
#SBATCH --output=out_copy_figure_data_files_global.txt
#SBATCH --error=error_copy_figure_data_files_global.txt
#SBATCH --export=ALL
...
FIGDIR="/projects/kopp/ar6/global/figure_data"
WFDIR="/projects/kopp/ar6/global/dist_workflows"
SCRIPTDIR="/projects/kopp/ar6/scripts"
PBDIR="/projects/kopp/ar6/global/pboxes"
...
srun python generate_year_of_exceedance_figure_data.py --indir ${PBDIR}/ --outdir ${FIGDIR}/
srun python generate_year_of_exceedance_figure_data.py --indir ${WFDIR}/ --outdir ${FIGDIR}/
