...
#SBATCH --job-name=larmip7
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1
#SBATCH --mem=128000
#SBATCH --time=8:00:00
#SBATCH --output=out_larmip7.txt
#SBATCH --error=error_larmip7.txt
#SBATCH --export=ALL
...
mv *tlim3.0win0.25*globalsl* ../output_global
mv *tlim3.0win0.25*localsl* ../output_local

rm *tlim3.0win0.25*.pkl
