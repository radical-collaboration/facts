...
export RP_TASK_ID="task.000001"
export RP_TASK_NAME="task.000001,task1,stage.0001,fit,pipeline.0000,test.GrIS1f.FittedISMIP.GrIS"
...
export RP_TASK_SANDBOX="$RP_PILOT_SANDBOX/task.000001"
...
export RP_PROF_TGT="$RP_PILOT_SANDBOX/task.000001/task.000001.prof"
...
tar -xvf FittedISMIP_icesheet_fit_data.tgz 2> /dev/null; rm FittedISMIP_icesheet_fit_data.tgz || rp_error pre_exec

# ------------------------------------------------------------------------------
# execute rank
$RP_PROF rank_start ""
mprof run -o mem_Grls_fit.dat "FittedISMIP_GrIS_fit.py" "--pipeline_id" "test.GrIS1f.FittedISMIP.GrIS" &
