...
# mprof run -o mem_fittedismip_preprocess.dat FittedISMIP_GrIS_preprocess.py "--scenario" "ssp585" "--pipeline_id" "configTest.GrIS1f.FittedISMIP.GrIS"
...
mkdir -p /opt/shared_data/global/
mkdir -p /opt/shared_data/local/
