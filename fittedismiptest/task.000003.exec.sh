...
export RP_TASK_ID="task.000003"
export RP_TASK_NAME="task.000003,task1,stage.0003,postprocess,pipeline.0000,test.GrIS1f.FittedISMIP.GrIS"
...
export RP_TASK_SANDBOX="$RP_PILOT_SANDBOX/task.000003"
...
export RP_PROF_TGT="$RP_PILOT_SANDBOX/task.000003/task.000003.prof"
...
tar -xvf grd_fingerprints_data.tgz 2> /dev/null; rm grd_fingerprints_data.tgz || rp_error pre_exec

# ------------------------------------------------------------------------------
# execute rank
$RP_PROF rank_start ""
mprof run -o mem_Grls_postprocess.dat "FittedISMIP_GrIS_postprocess.py" "--pipeline_id" "test.GrIS1f.FittedISMIP.GrIS" &
