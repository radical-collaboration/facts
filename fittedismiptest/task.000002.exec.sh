...
export RP_TASK_ID="task.000002"
export RP_TASK_NAME="task.000002,task1,stage.0002,project,pipeline.0000,test.GrIS1f.FittedISMIP.GrIS"
...
export RP_TASK_SANDBOX="$RP_PILOT_SANDBOX/task.000002"
...
export RP_PROF_TGT="$RP_PILOT_SANDBOX/task.000002/task.000002.prof"
...
# execute rank
$RP_PROF rank_start ""
mprof run -o mem_Grls_project.dat "FittedISMIP_GrIS_project.py" "--nsamps" "2000" "--pyear_start" "2020" "--pyear_end" "2150" "--pyear_step" "10" "--baseyear" "2005" "--pipeline_id" "test.GrIS1f.FittedISMIP.GrIS" &
